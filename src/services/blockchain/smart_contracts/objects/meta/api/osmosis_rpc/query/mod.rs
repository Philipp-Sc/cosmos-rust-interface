...
use osmosis_proto::osmosis::gamm::v1beta1::{QueryNumPoolsRequest, QueryNumPoolsResponse, QueryPoolsRequest, QueryPoolsResponse, Pool, QueryPoolRequest, QueryPoolResponse, QuerySwapExactAmountInRequest, QuerySwapExactAmountInResponse, SwapAmountInRoute, QuerySwapExactAmountOutRequest, QuerySwapExactAmountOutResponse, SwapAmountOutRoute};
